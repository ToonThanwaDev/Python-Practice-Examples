...
while True:
    ...
    query_country = ''
    query_country = simpledialog.askstring('Country', 'Type the name of a capital: ')
    ...
    if query_country in world_capital:
        ...
        messagebox.showinfo('Thanks', 'Thank you to teach me. I will difinitely know it next time.')
        new_capital = new_capital.capitalize()
        write_file(query_country, new_capital)
